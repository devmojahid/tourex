...
<div class="tg-listing-area tg-grey-bg pt-140 pb-130 p-relative z-index-9">
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing.jpg"
                                alt="listing">
                    ...
                    <div class="tg-listing-card-content p-relative">
                        ...
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">Two Hour Walking Tour of
                                Manhattan</a></h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing-2.jpg"
                                alt="listing">
                        </a>
                        <div class="tg-listing-2-mask">
                            <img class="w-100" src="assets/img/listing/listing-2/shape.png" alt="">
                    ...
                    <div class="tg-listing-card-content p-relative">
                        ...
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">When you visit the Eternal Dubai
                                City</a></h4>
                        <div class="tg-listing-card-review mb-5">
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".5s"
                ...
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing-3.jpg"
                                alt="listing">
                    ...
                    <div class="tg-listing-card-content p-relative">
                        ...
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">Vatican Museums, Sistine Chapel
                                Skip the Line</a></h4>
                        <div class="tg-listing-card-review mb-5">
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".6s"
                ...
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing-4.jpg"
                                alt="listing">
                    ...
                    <div class="tg-listing-card-content p-relative">
                        ...
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">win cities on opposite sides of
                                the</a></h4>
                        <div class="tg-listing-card-review mb-5">
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s"
                ...
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing-5.jpg"
                                alt="listing">
                        </a>
                        <div class="tg-listing-2-mask">
                            <img class="w-100" src="assets/img/listing/listing-2/shape.png" alt="">
                    ...
                    <div class="tg-listing-card-content p-relative">
                        ...
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">Day Oahu Tour Honolulu Pearl
                                Harbor, & Diamond</a></h4>
                        <div class="tg-listing-card-review mb-5">
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".8s"
                ...
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing-6.jpg"
                                alt="listing">
                            <span class="tg-listing-item-price-discount shape">New</span>
                        </a>
                        <div class="tg-listing-2-mask">
                    ...
                    <div class="tg-listing-card-content p-relative">
                        ...
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">Molokini and Turtle Arches
                                Snorkeling Trip</a></h4>
                        <div class="tg-listing-card-review mb-5">
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
                            <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i></span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".9s"
                ...
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing-10.jpg"
                                alt="listing">
                        </a>
                        <div class="tg-listing-2-mask">
                            <img class="w-100" src="assets/img/listing/listing-2/shape.png" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".9s"
                ...
                <div class="tg-listing-card-item tg-listing-2-card-item mb-25">
                    <div class="tg-listing-card-thumb tg-listing-2-card-thumb fix p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/listing-2/listing-8.jpg"
                                alt="listing">
                            <span class="tg-listing-item-price-discount shape">New</span>
                        </a>
                        <div class="tg-listing-2-mask">
            ...
            <div class="col-12 wow fadeInUp" data-wow-delay=".7s" data-wow-duration=".6s">
                <div class="tg-listing-2-btn text-center pt-25">
                    <a href="{{ getTranslatedValue($theme2_package, 'button_url') }}"
                        class="tg-btn tg-btn-switch-animation">
                        <span class="d-flex align-items-center justify-content-center">
                            <span class="btn-text">{{ getTranslatedValue($theme2_package, 'button_text') }}</span>
