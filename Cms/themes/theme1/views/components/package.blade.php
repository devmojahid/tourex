                    ...
                    <button class="active" data-filter="*">
                        ...
                        <span class="icon">
                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                ...
                                <path d="M16.5 2.5L8.8 10.2M16.5 2.5L11.6 16.5L8.8 10.2M16.5 2.5L2.5 7.4L8.8 10.2"
        ...
        <div class="row project-active-two">
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-four  cat-two">
                <div class="tg-listing-card-item mb-30">
                    ...
                    <div class="tg-listing-card-content">
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">The Pulau Seribu, Jakarta
                                Indonesia</a></h4>
                        <div class="tg-listing-card-duration-tour">
                            <span class="tg-listing-card-duration-map mb-5">
                                <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-four cat-three">
                <div class="tg-listing-card-item mb-30">
                    ...
                    <div class="tg-listing-card-content">
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">American Parks Trail end Rapid
                                City Express</a></h4>
                        <div class="tg-listing-card-duration-tour">
                            <span class="tg-listing-card-duration-map mb-5">
                                <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer  cat-one cat-five">
                <div class="tg-listing-card-item mb-30">
                    ...
                    <div class="tg-listing-card-content">
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">southwestern Switzerland Akam
                                City</a></h4>
                        <div class="tg-listing-card-duration-tour">
                            <span class="tg-listing-card-duration-map mb-5">
                                <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 grid-item grid-sizer cat-four">
                <div class="tg-listing-card-item mb-30">
                    ...
                    <div class="tg-listing-card-content">
                        <h4 class="tg-listing-card-title"><a href="tour-details.html">Modern Stefano La Piazze
                                Wergeland</a></h4>
                        <div class="tg-listing-card-duration-tour">
                            <span class="tg-listing-card-duration-map mb-5">
                                <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
