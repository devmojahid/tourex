...
<div class="tg-listing-area tg-listing-su-spacing tg-grey-bg-2 pt-120 p-relative">
    <img class="tg-listing-su-shape d-none d-xl-block" src="{{ asset('frontend/assets/img/shape/air-plane-2.png') }}" alt="">
    <img class="tg-listing-su-shape-2 d-none d-xxl-block" src="{{ asset('frontend/assets/img/shape/bag.png') }}" alt="">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                    ...
                    <div class="tg-listing-card-content">
                        ...
                        <h4 class="tg-listing-card-title mb-10"><a href="tour-details.html">Two Hour Walking Tour great
                                of Manhattan jeihcen</a></h4>
                        ...
                        <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                            ...
                            <div>
                                <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i>
                                    4.5</span>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                    ...
                    <div class="tg-listing-card-content">
                        ...
                        <h4 class="tg-listing-card-title mb-10"><a href="tour-details.html">Two Hour Walking Tour
                                great of Manhattan jeihcen</a></h4>
                        <div class="tg-listing-card-duration-tour mb-20">
                            <span class="tg-listing-card-duration-map">
                                <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                            <div>
                                <span class="tg-listing-card-currency-amount d-flex align-items-center">
                                    <span class="currency-symbol mr-5">From</span>$270
                                </span>
                            </div>
                            <div>
                                <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                    <div class="tg-listing-card-thumb fix mb-25 p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/su/listing-3.jpg"
                                alt="listing">
                            <span class="tg-listing-item-price-discount">Featured</span>
                        </a>
                        <div class="tg-listing-item-wishlist">
                    ...
                    <div class="tg-listing-card-content">
                        ...
                        <h4 class="tg-listing-card-title mb-10"><a href="tour-details.html">When you visit the Eternal
                                Dubai City</a></h4>
                        <div class="tg-listing-card-duration-tour mb-20">
                            <span class="tg-listing-card-duration-map">
                                <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
                        ...
                        <div class="tg-listing-card-price d-flex align-items-end justify-content-between">
                            <div>
                                <span class="tg-listing-card-currency-amount d-flex align-items-center">
                                    <span class="currency-symbol mr-5">From</span>$420
                                </span>
                            </div>
                            <div>
                                <span class="tg-listing-rating-icon"><i class="fa-sharp fa-solid fa-star"></i>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                    <div class="tg-listing-card-thumb fix mb-25 p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/su/listing-4.jpg"
                                alt="listing">
                            <span class="tg-listing-item-price-discount">Featured</span>
                        </a>
                        <div class="tg-listing-item-wishlist">
                    ...
                    <div class="tg-listing-card-content">
                        ...
                        <h4 class="tg-listing-card-title mb-10"><a href="tour-details.html">Vatican Museums, Sistine
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                    <div class="tg-listing-card-thumb fix mb-25 p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/su/listing-5.jpg"
                                alt="listing">
                            <span class="tg-listing-item-price-discount">Featured</span>
                        </a>
                        <div class="tg-listing-item-wishlist">
                    ...
                    <div class="tg-listing-card-content">
                        ...
                        <h4 class="tg-listing-card-title mb-10"><a href="tour-details.html">Day Oahu Tour Honolulu
                                Pearl Harbor, & Diamond</a></h4>
                        <div class="tg-listing-card-duration-tour mb-20">
                            <span class="tg-listing-card-duration-map">
                                <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="tg-listing-card-item tg-listing-su-card-item mb-25">
                    <div class="tg-listing-card-thumb fix mb-25 p-relative">
                        <a href="tour-details.html">
                            <img class="tg-card-border w-100" src="assets/img/listing/su/listing-6.jpg"
                                alt="listing">
                        </a>
                        <div class="tg-listing-item-wishlist">
                            <a href="#">
            ...
            <div class="col-12">
                <div class="text-center mt-15">
                    <a href="{{ getTranslatedValue($theme3_package, 'button_url') }}" class="tg-btn tg-btn-transparent tg-btn-su-transparent">
