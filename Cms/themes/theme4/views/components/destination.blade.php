@php
    ...
    $home4_destination_items = popularDestinations(5, false);
@endphp
            ...
            <div class="row gx-30">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                    <div class="tg-location-3-wrap tg-location-su-wrap p-relative tg-round-25 wow fadeInUp"
                        ...
                        <div class="tg-location-thumb tg-round-25">
                            <img class="w-100 tg-round-25" src="assets/img/location/su/destination-2.jpg"
                                alt="location">
                        </div>
                        <div class="tg-location-content tg-location-su-content">
                            <div class="content">
                ...
                <div class="col-xl-6 col-lg-4 col-md-6 mb-30">
                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative tg-round-25 wow fadeInUp"
                        ...
                        <div class="tg-location-thumb tg-round-25">
                            <img class="w-100 tg-round-25" src="assets/img/location/su/destination-3.jpg"
                                alt="location">
                        </div>
                        <div class="tg-location-content tg-location-su-content">
                            <div class="content">
                ...
                <div class="col-xl-6 col-lg-4 col-md-6 mb-30">
                    <div class="tg-location-3-wrap  tg-location-su-wrap  p-relative tg-round-25 wow fadeInUp"
                        ...
                        <div class="tg-location-thumb tg-round-25">
                            <img class="w-100 tg-round-25" src="assets/img/location/su/destination-4.jpg"
                                alt="location">
                        </div>
                        <div class="tg-location-content tg-location-su-content">
                            <div class="content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                    <div class="tg-location-3-wrap tg-location-su-wrap p-relative tg-round-25 wow fadeInUp"
                        ...
                        <div class="tg-location-thumb tg-round-25">
                            <img class="w-100 tg-round-25" src="assets/img/location/su/destination-5.jpg"
                                alt="location">
                        </div>
                        <div class="tg-location-content tg-location-su-content">
                            <div class="content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                    <div class="tg-location-3-wrap tg-location-su-wrap p-relative tg-round-25 wow fadeInUp"
                        ...
                        <div class="tg-location-thumb tg-round-25">
                            <img class="w-100 tg-round-25" src="assets/img/location/su/destination-6.jpg"
                                alt="location">
                        </div>
                        <div class="tg-location-content tg-location-su-content">
                            <div class="content">
