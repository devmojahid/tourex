...
<div class="tg-pricing-area tg-pricing-su-wrap pb-100 pt-130 p-relative z-index-1">
    ...
    <img class="tg-pricing-su-shape-2 p-absolute d-none d-md-block" src="{{ asset('frontend/assets/img/shape/parasut.png') }}" alt="">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="tg-pricing-wrap mb-30 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".9s">
                    <div class="tg-pricing-head">
                        <h4 class="tg-pricing-title mb-15">Basic</h4>
