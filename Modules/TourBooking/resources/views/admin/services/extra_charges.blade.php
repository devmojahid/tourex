...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Tour Booking') }} >> {{ __('translate.Services') }} >> {{ __('translate.Extra Charges') }}</p>
@endsection
                                ...
                                <div class="col-12 mg-top-30">
                                    <div class="crancy-product-card">
                                        <div class="create_new_btn_inline_box">
                                            <h4 class="crancy-product-card__title">{{ __('translate.Extra Charges for') }}: {{ $service->translation->title ?? $service->title }}</h4>
                                            <div>
                                                            ...
                                                            <div class="accordion-body">
                                                                <form action="{{ route('admin.tourbooking.services.extra-charges.store', $service->id) }}" method="POST">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3 col-md-3 col-12">
                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                ...
                                                                                <div class="crancy__item-form--currency">
                                                                                    <input class="crancy__item-input" type="number" step="0.01" name="price" value="{{ old('price') }}" required>
                                                                        ...
                                                                        <div class="col-lg-3 col-md-3 col-12">
                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                <label class="crancy__item-label">{{ __('translate.Price Type') }} *</label>
                                                                                <select class="crancy__item-input" name="price_type" required>
                                                                                    <option value="flat" {{ old('price_type') == 'flat' ? 'selected' : '' }}>{{ __('translate.Flat Fee') }}</option>
                                                                                    <option value="per_booking" {{ old('price_type') == 'per_booking' ? 'selected' : '' }}>{{ __('translate.Per Booking') }}</option>
                                                                                    <option value="per_person" {{ old('price_type') == 'per_person' ? 'selected' : '' }}>{{ __('translate.Per Person') }}</option>
                                                                                    <option value="per_adult" {{ old('price_type') == 'per_adult' ? 'selected' : '' }}>{{ __('translate.Per Adult') }}</option>
                                                                                    <option value="per_child" {{ old('price_type') == 'per_child' ? 'selected' : '' }}>{{ __('translate.Per Child') }}</option>
                                                                                    <option value="per_infant" {{ old('price_type') == 'per_infant' ? 'selected' : '' }}>{{ __('translate.Per Infant') }}</option>
                                                                                    <option value="per_night" {{ old('price_type') == 'per_night' ? 'selected' : '' }}>{{ __('translate.Per Night') }}</option>
                                                                                </select>
                                                                                @error('price_type')
                                                                                    <span class="text-danger">{{ $message }}</span>
                                                                                @enderror
                                                                        ...
                                                                        <div class="col-lg-4 col-md-4 col-12">
                                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                                ...
                                                                                <div class="crancy-ptabs__notify-switch crancy-ptabs__notify-switch--two">
                                                                                    <label class="crancy__item-switch">
                                                                                        <input name="is_tax" type="checkbox" {{ old('is_tax') ? 'checked' : '' }}>
                                                                                        <span class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            @if($charge->description)
                                                                <div class="small text-muted">{{ Str::limit($charge->description, 50) }}</div>
                                                            @endif
                                                        </td>
                                                        <td>{{ config('settings.currency_icon', '$') }} {{ $charge->price }}</td>
                                                        ...
                                                        <td>
                                                            @if($charge->is_tax)
                                                                <span class="crancy-badge crancy-badge-info">{{ __('translate.Yes') }} ({{ $charge->tax_percentage }}%)</span>
                                                            @else
                                                                <span class="crancy-badge crancy-badge-secondary">{{ __('translate.No') }}</span>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td class="crancy-table__action">
                                                            <div class="crancy-table__action-btn">
                                                                <a href="#" class="crancy-action__btn crancy-action__edit" data-bs-toggle="modal" data-bs-target="#editModal{{ $charge->id }}"><i class="fa fa-edit"></i></a>
                                                                <a href="#" class="crancy-action__btn crancy-action__delete" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $charge->id }}"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </td>

                                                        <!-- Edit Modal -->
                                                        <div class="modal fade" id="editModal{{ $charge->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $charge->id }}" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="editModalLabel{{ $charge->id }}">{{ __('translate.Edit Extra Charge') }}</h5>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-3 col-md-3 col-12">
                                                                                    <div class="crancy__item-form--group">
                                                                                        <label class="crancy__item-label">{{ __('translate.Price') }} *</label>
                                                                                        <div class="crancy__item-form--currency">
                                                                                            <input class="crancy__item-input" type="number" step="0.01" name="price" value="{{ $charge->price }}" required>
                                                                                            <div class="crancy__currency-icon">
                                                                                                <span>{{ config('settings.currency_icon', '$') }}</span>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                <div class="col-lg-3 col-md-3 col-12">
                                                                                    <div class="crancy__item-form--group">
                                                                                        <label class="crancy__item-label">{{ __('translate.Price Type') }} *</label>
                                                                                        <select class="crancy__item-input" name="price_type" required>
                                                                                            <option value="flat" {{ $charge->price_type == 'flat' ? 'selected' : '' }}>{{ __('translate.Flat Fee') }}</option>
                                                                                            <option value="per_booking" {{ $charge->price_type == 'per_booking' ? 'selected' : '' }}>{{ __('translate.Per Booking') }}</option>
                                                                                            <option value="per_person" {{ $charge->price_type == 'per_person' ? 'selected' : '' }}>{{ __('translate.Per Person') }}</option>
                                                                                            <option value="per_adult" {{ $charge->price_type == 'per_adult' ? 'selected' : '' }}>{{ __('translate.Per Adult') }}</option>
                                                                                            <option value="per_child" {{ $charge->price_type == 'per_child' ? 'selected' : '' }}>{{ __('translate.Per Child') }}</option>
                                                                                            <option value="per_infant" {{ $charge->price_type == 'per_infant' ? 'selected' : '' }}>{{ __('translate.Per Infant') }}</option>
                                                                                            <option value="per_night" {{ $charge->price_type == 'per_night' ? 'selected' : '' }}>{{ __('translate.Per Night') }}</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-12">
                                                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                                                        <label class="crancy__item-label">{{ __('translate.Description') }}</label>
                                                                                        <textarea class="crancy__item-input" name="description" rows="3">{{ $charge->description }}</textarea>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                                                        ...
                                                                                        <div class="crancy-ptabs__notify-switch crancy-ptabs__notify-switch--two">
                                                                                            <label class="crancy__item-switch">
                                                                                                <input name="is_mandatory" type="checkbox" {{ $charge->is_mandatory ? 'checked' : '' }}>
                                                                                                <span class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                                                        ...
                                                                                        <div class="crancy-ptabs__notify-switch crancy-ptabs__notify-switch--two">
                                                                                            <label class="crancy__item-switch">
                                                                                                <input name="is_tax" type="checkbox" class="tax-toggle" {{ $charge->is_tax ? 'checked' : '' }}>
                                                                                                <span class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-lg-4 col-md-4 col-12">
                                                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                                                        ...
                                                                                        <div class="crancy-ptabs__notify-switch crancy-ptabs__notify-switch--two">
                                                                                            <label class="crancy__item-switch">
                                                                                                <input name="status" type="checkbox" {{ $charge->status ? 'checked' : '' }}>
                                                                                                <span class="crancy__item-switch--slide crancy__item-switch--round"></span>
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                        ...
                                                        <!-- Delete Modal -->
                                                        <div class="modal fade" id="deleteModal{{ $charge->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $charge->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="deleteModalLabel{{ $charge->id }}">{{ __('translate.Confirm Delete') }}</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="crancy-btn crancy-btn__default" data-bs-dismiss="modal">{{ __('translate.Cancel') }}</button>
                                                                        <form action="{{ route('admin.tourbooking.services.extra-charges.destroy', $charge->id) }}" method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
