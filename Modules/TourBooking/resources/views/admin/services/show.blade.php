                                                ...
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">
                                                            {{ $service->serviceType->name ?? 'Not set' }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">
                                                            {{ $service->destination->name ?? 'Not set' }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Location') }}</div>
                                                        <div class="detail-value">{{ $service->location ?: 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->duration ?: 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->group_size ?: 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->room_count ?: 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">{{ $service->adult_count ?: 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">
                                                            {{ $service->children_count ?: 'Not set' }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">
                                                            {{ $service->check_in_time ?: 'Not set' }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value">
                                                            {{ $service->check_out_time ?: 'Not set' }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="detail-item">
                                                        <div class="detail-label">{{ __('translate.Ticket') }}</div>
                                                        <div class="detail-value">{{ $service->ticket ?: 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                    ...
                                    <div class="service-detail-card">
                                        ...
                                        <div class="service-detail-body">
                                            ...
                                            @if ($service->google_map_sub_title)
                                                <div class="detail-item">
                                                    <div class="detail-label">Google Map Sub Title
                                                    </div>
                                            ...
                                            @if ($service->google_map_url)
                                                <div class="detail-item">
                                                    ...
                                                    <div class="detail-value">
                                                        <a href="{{ $service->google_map_url }}" target="_blank">View on
                                                            Google Maps</a>
                                                    </div>
                                                </div>
                                            @endif
