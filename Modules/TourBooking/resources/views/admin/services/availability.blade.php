                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                                            ...
                                                            <div class="accordion-body">
                                                                <form
                                                                    action="{{ route('admin.tourbooking.services.availability.store', $service->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                                ...
                                                                <div class="modal fade"
                                                                    ...
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('admin.tourbooking.services.availability.update', $availability->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('PUT')
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-bs-dismiss="modal">{{ __('translate.Cancel') }}</button>
                                                                                <form
                                                                                    action="{{ route('admin.tourbooking.services.availability.destroy', $availability->id) }}"
                                                                                    method="POST">
                                                                                    @csrf
                                                                                    @method('DELETE')
                                                                                    <button type="submit"
    ...
    <div class="modal fade" id="bulkAddModal" tabindex="-1" aria-labelledby="bulkAddModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.tourbooking.services.availability.store', $service->id) }}" method="POST">
                    @csrf
