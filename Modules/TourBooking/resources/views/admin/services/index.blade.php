                                    ...
                                    <table class="crancy-table__main crancy-table__main-v3  no-footer" id="dataTable">
                                        <thead class="crancy-table__head">
                                            <tr>
                                                ...
                                                <th class="crancy-table__column-2 crancy-table__h2 sorting">{{ __('translate.Price') }}</th>
                                        ...
                                        <tbody class="crancy-table__body">
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td class="crancy-table__column-2 crancy-table__data-2">{{ $service->translation->title ?? $service->title }}</td>
                                                <td class="crancy-table__column-2 crancy-table__data-2">{{ $service->serviceType->name ?? 'N/A' }}</td>
                                                <td class="crancy-table__column-2 crancy-table__data-2">{{ $service->location ?? 'N/A' }}</td>
                                                <td class="crancy-table__column-2 crancy-table__data-2">
                                                ...
                                                <td class="crancy-table__action">
                                                    <div class="crancy-table__action-btn">
                                                        ...
                                                        <a onclick="itemDeleteConfrimation({{ $service->id }})" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="crancy-btn delete_danger_btn"><i class="fas fa-trash"></i> </a>
