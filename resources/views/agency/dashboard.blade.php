                                            ...
                                            <span>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#6440FB" stroke-width="1.5" stroke-linecap="round"></path>
                                            ...
                                            <span>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#6440FB" stroke-width="1.5" stroke-linejoin="round"></path>
                                                    <path
                                        ...
                                        <div class="flex-main">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="crancy-ecom-card__content">
                                                    <div class="crancy-ecom-card__camount">
                                                        <div class="crancy-ecom-card__camount__inside">
                                                            <h3 class="crancy-ecom-card__amount">{{ $course_sale_qty }}
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">
                                                {{ __('translate.Latest Enrollments') }}</h4>
                                        </div>
                                    </div>
                                </div>
