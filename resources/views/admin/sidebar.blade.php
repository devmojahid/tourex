...
<div class="admin-menu__one crancy-sidebar-padding mg-top-20">
    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
                    ...
                    href="{{ route('admin.earning-and-revenue') }}"><span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            ...
                            <svg class="crancy-svg-icon" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path d="M12 9.5V11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M12 18V19.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
            ...
            <li
                class="{{ Route::is('admin.category.*') || Route::is('admin.courselevel.*') || Route::is('admin.courselanguage.*') || Route::is('admin.courses.*') || Route::is('admin.course-curriculum') || Route::is('admin.course-lesson') || Route::is('admin.course-media') || Route::is('admin.submit-for-review') || Route::is('admin.pending-course') || Route::is('admin.rejected-course') || Route::is('admin.active-course') || Route::is('admin.course-seo') ? 'active' : '' }}">
                ...
                <!-- Dropdown Menu -->
                <div class="collapse crancy__dropdown {{ Route::is('admin.category.*') || Route::is('admin.courselevel.*') || Route::is('admin.courselanguage.*') || Route::is('admin.courses.*') || Route::is('admin.course-curriculum') || Route::is('admin.course-lesson') || Route::is('admin.course-media') || Route::is('admin.submit-for-review') || Route::is('admin.pending-course') || Route::is('admin.rejected-course') || Route::is('admin.active-course') || Route::is('admin.course-seo') ? 'show' : '' }}"
                    ...
                    <ul class="menu-bar__one-dropdown">
                        ...
                        <li><a href="{{ route('admin.courses.create') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Create Course') }}</span></span></a>
                        </li>
                        ...
                        <li><a href="{{ route('admin.active-course') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Active Course') }}</span></span></a>
                        </li>

                        <li><a href="{{ route('admin.pending-course') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Awaiting Course') }}</span></span></a>
                        </li>

                        <li><a href="{{ route('admin.rejected-course') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Rejected Course') }}</span></span></a>
                        </li>

                        <li><a href="{{ route('admin.courselevel.index') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Course Level') }}</span></span></a>
                        </li>

                        <li><a href="{{ route('admin.courselanguage.index') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Course Language') }}</span></span></a>
                        </li>
