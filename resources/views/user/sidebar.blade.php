...
<div class="admin-menu__one crancy-sidebar-padding mg-top-20">
    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
            ...
            <li class="{{ Route::is('user.enrolled-courses') || Route::is('user.enrolled-course') ? 'active' : '' }}"><a
                    class="collapsed" href="{{ route('user.enrolled-courses') }}"><span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
            ...
            <li class="{{ Route::is('user.event-calendar') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('user.event-calendar') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="{{ Route::is('user.notice-board') ? 'active' : '' }}"><a class="collapsed"
                    href="{{ route('user.notice-board') }}">
                    <span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.99805 16H11.998M7.99805 11H15.998" stroke="currentColor"
