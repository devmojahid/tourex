      ...
      <div class="container">
        <div class="td_top_header_in">
          ...
          <div class="td_top_header_right">
            ...
            <span>
              @guest('web')
                <a href="{{ route('user.login') }}" class="">{{ __('translate.Login') }}</a> /
                <a href="{{ route('user.register') }}" class="">{{ __('translate.Register') }}</a>
                @else
                <a href="{{ Auth::guard('web')->user()->is_seller == 1 ? route('instructor.dashboard') : route('user.dashboard') }}" class="">{{ __('translate.Dashboard') }}</a>
              @endguest
        ...
        <div class="td_main_header_in">
          ...
          <div class="td_main_header_right">
            ...
            <div class="td_hero_icon_btns position-relative">
              ...
              <a class="td_circle_btn td_center td_wishlist_btn" href="{{ route('user.wishlist.index') }}">
                <span class="d-inline-flex">
