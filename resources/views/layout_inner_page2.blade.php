...
<body class="td_theme_2">
                            ...
                            <div class="tgmenu__wrap d-flex align-items-center">
                                <div class="logo flex-auto">
                                    <a href="{{ route('home') }}"><img
                                            src="{{ asset($general_setting->logo) }}" alt="Logo">
                                    </a>
                                </div>
                            ...
                            <div class="tg-menu-right-action tg-menu-right-action-3 tg-menu-4-right-action d-flex align-items-center justify-content-end">
                                ...
                                <div class="tg-header-cart p-relative d-none d-xl-block">
                                    <button class="cart-button">
                                        ...
                                        <span class="tg-header-cart-count">{{ count($carts) }}</span>
                                    </button>
                                    <div class="minicart">
    ...
    <!-- footer-area-start -->
    <footer>
        <div class="tg-footer-area pt-130 include-bg {{ request()->routeIs('faq') || request()->routeIs('pricing') ? 'tg-footer-space' : '' }} " data-background="{{ asset('frontend/assets/img/others/footer/footer.jpg'); }}">
            <div class="container">
